...
princp=[]
try:
	prox= requests.get('https://github.com/SADIM-143/Api/blob/main/prox.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/SADIM-143/ua/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
def passwrd():
	...
	print(f'\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mTOTAL IDz :\033[0;97m '+str(len(id)))
	print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[0;95mCloning Speed Super Fast")
...
def Subscraption():
	...
	r1=requests.get("https://github.com/SADIM-143/Control-Room/blob/main/paid.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
